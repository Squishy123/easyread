                    ...
                    return (
                        (a.imgLoad = function() {
                            ...
                            this.state.captures[
                                ...
                                var n = a.boundingBox,
                                    c = e.original.current.getBoundingClientRect();
                                t.push({
                                    str: a.text,
                                    el: r.a.createElement(h.a, {
                                        key: a.text + Math.random(),
                                        x: n[6] + c.x,
                                        y: n[7] + c.y - Math.abs(n[1] - n[7]),
                                        text: a.text,
        ...
        211: function(e, t, a) {
                ...
                E = function(e) {
                    ...
                    if ('string' == typeof t && t.length > 2) {
                        var a,
                            n,
                            r,
                            c = (t = b ? t.trim() : d(t, 3)).charCodeAt(0);
                        if (43 === c || 45 === c) {
            ...
            if (!f(' 0o1') || !f('0b1') || f('+0x1')) {
                ...
                for (
                    ...
                    r(m, (y = v[N])) && !r(f, y) && p(f, y, u(m, y));
                (f.prototype = g), (g.constructor = f), a(16)(n, 'Number', f);
            }
        },
        212: function(e, t, a) {
            var n = a(11),
...
//# sourceMappingURL=component---src-pages-gallery-js-611126105a6f269a8e86.js.map
